...
use app\models\ReagentsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ReagentsController implements the CRUD actions for Reagents model.
 */
class ReagentsController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'add-external-reagents', 'add-solution-to-external-reagents'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * Lists all Reagents models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new ReagentsSearch();
    ...
    /**
     * Displays a single Reagents model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Reagents model.
    ...
    /**
     * Deletes an existing Reagents model.
    ...
    /**
     * 
     * Export Reagents information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Finds the Reagents model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Reagents the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Reagents::findOne($id)) !== null) {
            return $model;
        } else {
