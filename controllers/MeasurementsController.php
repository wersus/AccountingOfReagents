...
class MeasurementsController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'add-act-of-renewal-reagents'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Measurements information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    {
        if (($model = Measurements::findOne($id)) !== null) {
            return $model;
        } else {
