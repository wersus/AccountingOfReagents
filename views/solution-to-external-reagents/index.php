...
/* @var $searchModel app\models\SolutionToExternalReagentsSearch */
...
$this->title = Yii::t('app', 'Solution To External Reagents');
...
?>
<div class="solution-to-external-reagents-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Solution To External Reagents'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    if ($model->solutions)
                    {return $model->solutions->name;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Solutions::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Solutions', 'id' => 'grid-solution-to-external-reagents-search-id_solutions']
            ],
        [
                'attribute' => 'id_solutions_two',
                'label' => Yii::t('app', 'Id Solutions Two'),
                'value' => function($model){
                    if ($model->solutionsTwo)
                    {return $model->solutionsTwo->name;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'Solutions', 'id' => 'grid-solution-to-external-reagents-search-id_solutions_two']
            ],
        [
