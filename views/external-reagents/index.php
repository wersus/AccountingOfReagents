...
/* @var $searchModel app\models\ExternalReagentsSearch */
...
$this->title = Yii::t('app', 'External Reagents');
...
?>
<div class="external-reagents-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create External Reagents'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){
                    ...
                    {return $model->manufacturers->name;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Manufacturers::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
        ...
        'volume',
        [
                'attribute' => 'id_qualifications',
                'label' => Yii::t('app', 'Id Qualifications'),
                'value' => function($model){
                    if ($model->qualifications)
                    {return $model->qualifications->name;}
                    else
                    {return NULL;}
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\models\Qualifications::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Qualifications', 'id' => 'grid-external-reagents-search-id_qualifications']
            ],
        'description:ntext',
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Shelf lifes', 'id' => 'grid-external-reagents-search-id_shelf_lifes']
            ],
        [
