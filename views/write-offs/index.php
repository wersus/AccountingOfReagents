...
/* @var $searchModel app\models\WriteOffsSearch */
...
$this->title = Yii::t('app', 'Write Offs');
...
?>
<div class="write-offs-index">

    <h1><?= Html::encode($this->title) ?></h1>
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>

    <p>
        <?= Html::a(Yii::t('app', 'Create Write Offs'), ['create'], ['class' => 'btn btn-success']) ?>
